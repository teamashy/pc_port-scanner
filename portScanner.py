...
# Ports found open can be prompted by forwarding a hexadecimal byte to them (sending data).
# Such prompts usually return information about the system on the other end, i.e. if it's port 3306 it could return the SQL server in user.
